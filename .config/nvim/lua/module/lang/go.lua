			...
			config = function()
				require("go").setup({
					...
					lsp_on_attach = function(client, bufnr)
						local on_attach = require("module.tool.lsp").fn.on_attach
				...
				-- let tool.format handle formatting for us
				if user.module("tool.format") then
					local format = require("module.tool.format")
					format.fn.set_formatters_ft("go", { "goimports", "gofumpt" })
				end
			end,
		},
	},
